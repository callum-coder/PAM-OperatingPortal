...
export const agents: AgentDefinition[] = [
  ...
  },
  {
    ...
    reportsTo: "gtm-lead",
    description:
      "Fetches each watched competitor page daily, diffs it against the stored snapshot, and on a real change classifies significance for PAM and proposes a response.",
    module: "gtm",
    model: null,
    doctrine: ["competitors-watch.md"],
    schedule: "0 5 * * *",
    outputs: ["gtm_competitor_changes", "gtm_competitor_watch", "gtm_agent_runs"],
    tools: "read-only",
    status: "active",
  },
  {
